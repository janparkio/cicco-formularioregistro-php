...
const TEST_DATA_GENERATOR = {
  ...
  generateTestData() {
    ...
    return {
      ...
      "birth-month": birthDate.getMonth().toString().padStart(2, '0'),
      "birth-day": birthDate.getDate().toString().padStart(2, '0'),
      "mobile-phone": `981${String(100000 + counter).slice(-6)}`,
