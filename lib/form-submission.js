...
function prepareFormData(rawFormData) {
  ...
  // Map form fields from client-side names to server-side names
  ...
  // Handle research areas - this now handles both form and Python keys
...
async function handleFormSubmission(form, formData) {
  ...
  try {
    ...
    if (result.debug?.formData) {
      console.log('Debug - Form Data:', result.debug.formData);
    }
