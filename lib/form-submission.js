...
function submitForm(event) {
  ...
  // Add the captcha token and challenge
  preparedData.append("captcha_token", captchaToken);
  preparedData.append("captcha_challenge", captchaToken); // The server expects this field
