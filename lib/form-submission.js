...
async function handleFormSubmission(form, formData) {
  ...
  try {
    ...
    if (result.success) {
      ...
      showErrorMessage(result.message || "Error desconocido en el procesamiento del formulario.");
    }
  } catch (error) {
    console.error("Error en el envío:", error);
    showErrorMessage(`Hubo un error al enviar el formulario: ${error.message}. Por favor, inténtelo de nuevo o contacte al soporte técnico.`);
  } finally {
