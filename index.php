    ...
    <main>
        <section class="bg-gray-50">
            <div class="w-full max-w-7xl mx-auto">
                <header>
                    <nav class="flex flex-col xl:flex-row items-center justify-between p-4 lg:px-8 gap-y-4 xl:gap-x-4 overflow-x-hidden" aria-label="Logo">
                        ...
                        <div class="flex-1 flex flex-col xl:flex-row items-center xl:items-end justify-center xl:justify-end">
                            <div class="text-center xl:text-right truncate">
                                <h2 class="text-sm sm:text-base lg:text-lg font-semibold leading-tight text-gray-900 truncate">Formulario de regístro de usuario</h2>
                                <p class="text-xs sm:text-sm font-light leading-tight text-gray-900 mt-1 truncate">Última
